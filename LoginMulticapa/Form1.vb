...
Public Class Form1
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If bd.ComprobarLogin(TextBox1.Text, TextBox2.Text) > 0 Then
...
Public Class Jugador
    ...
    Public Sub New(ByVal pId As UInteger, ByVal pNick As Integer, ByVal pNom As String)
        Me.ID_JUGADOR = pId
        Me.PASSWORD_JUGADOR = pNom
    End Sub
    Public Overrides Function ToString() As String
        Return PASSWORD_JUGADOR
    End Function

    Public Shared Function ComprobarLogin() As Boolean
